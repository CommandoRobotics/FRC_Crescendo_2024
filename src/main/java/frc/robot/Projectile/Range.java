...
public class Range implements Comparable<Range> {
    ...
    @Override
    // returns a negative integer if current object is less than specified object
    //returns a zero if they are equal
    //returns a positive if the current object is greater than the specified object
