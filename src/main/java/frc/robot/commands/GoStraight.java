...
public class GoStraight extends SequentialCommandGroup {
  ...
  public GoStraight(ArmSubsystem armSubsystem, DispenserSubsystem dispenserSubsystem, AutoAim autoAim, Positioning positioning, SwerveSubsystem swerveSubsystem) {
