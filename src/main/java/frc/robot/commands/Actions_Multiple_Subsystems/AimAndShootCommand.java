...
import frc.robot.commands.Swerve.DriveDisCommand;
...
public class AimAndShootCommand extends SequentialCommandGroup {
  ...
  public AimAndShootCommand(ArmSubsystem armSubsystem, DispenserSubsystem dispenserSubsystem, AutoAim autoAim, Positioning positioning, SwerveSubsystem swerveSubsystem) {
