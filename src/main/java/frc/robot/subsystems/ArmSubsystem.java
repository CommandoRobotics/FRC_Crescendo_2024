...
public class ArmSubsystem extends SubsystemBase {
  ...
  /** Set the votage of both arm motors */
  ...
  /** 
   * Sets the votage of both arm motors from a SmartDashboard variable called "Arm Voltage" 
   * Used for debugging
  */
  ...
  /** Takes a given power and scales it to a maximum power (so we don't go up or down too fast) */
  ...
  /**
   * Sets the setpoint in degrees that the arm should go to. This comand should be called
   * repeatedly to keep the arm at the right angle.
   * @param newSetpoint Angle in degrees for the arm to go to
