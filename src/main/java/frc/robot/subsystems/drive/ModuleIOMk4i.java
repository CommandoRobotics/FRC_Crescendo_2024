 ...
 */
public class ModuleIOMk4i implements ModuleIO {
  ...
  public ModuleIOMk4i(int index) {
    switch (index) {
      ...
      case 1:
        ...
        absoluteEncoderOffset = new Rotation2d(165.96); // MUST BE CALIBRATED
        break;
      case 2:
        ...
        absoluteEncoderOffset = new Rotation2d(83.36); // MUST BE CALIBRATED
        break;
      case 3:
        ...
        absoluteEncoderOffset = new Rotation2d(268.56); // MUST BE CALIBRATED
        break;
      default:
